...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
    ...
    <div class="layout-wrapper landing">
        <nav class="navbar navbar-expand-lg navbar-landing fixed-top is-sticky" id="navbar">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <a href="{{ route('tenant.login') }}" class="btn btn-link fw-medium text-decoration-none text-body">Iniciar sesión</a>
                        <a href="{{ route('tenant.register') }}" class="btn btn-primary">Registrarse</a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="text-center mt-5">
                            ...
                            <div class="swiper trusted-client-slider mt-sm-5 mt-4 mb-sm-5 mb-4 swiper-initialized swiper-horizontal swiper-backface-hidden" dir="ltr">
                                <div class="swiper-wrapper" id="swiper-wrapper-a6f6fdb68a5ca5f2" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-573px, 0px, 0px);">
                                    ...
                                    <div class="swiper-slide swiper-slide-prev" style="width: 256.5px; margin-right: 30px;" role="group" aria-label="2 / 6" data-swiper-slide-index="1">
                                        <div class="client-images">
                                            <img src="assets/images/clients/walmart.svg" alt="client-img" class="mx-auto img-fluid d-block">
                                        </div>
                                    </div>
                                    <div class="swiper-slide swiper-slide-active" style="width: 256.5px; margin-right: 30px;" role="group" aria-label="3 / 6" data-swiper-slide-index="2">
                                        <div class="client-images">
                                            <img src="assets/images/clients/lenovo.svg" alt="client-img" class="mx-auto img-fluid d-block">
                                        </div>
                                    </div>
                                    <div class="swiper-slide swiper-slide-next" style="width: 256.5px; margin-right: 30px;" role="group" aria-label="4 / 6" data-swiper-slide-index="3">
                                        <div class="client-images">
                                            <img src="assets/images/clients/paypal.svg" alt="client-img" class="mx-auto img-fluid d-block">
                                        </div>
                                    </div>
                                    <div class="swiper-slide" style="width: 256.5px; margin-right: 30px;" role="group" aria-label="5 / 6" data-swiper-slide-index="4">
                                        <div class="client-images">
                                            <img src="assets/images/clients/shopify.svg" alt="client-img" class="mx-auto img-fluid d-block">
                                        </div>
                                    </div>
                                    <div class="swiper-slide" role="group" aria-label="6 / 6" data-swiper-slide-index="5" style="width: 256.5px; margin-right: 30px;">
                                        <div class="client-images">
                    ...
                    <div class="col-lg-10">
                        <div class="text-center">
                            ...
                            <div class="swiper client-review-swiper rounded swiper-initialized swiper-horizontal swiper-backface-hidden" dir="ltr">
                                <div class="swiper-wrapper" id="swiper-wrapper-98373dbb333460de" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-926px, 0px, 0px);">
                                    <div class="swiper-slide swiper-slide-prev" style="width: 926px;" role="group" aria-label="1 / 3">
                                        <div class="row justify-content-center">
                                            <div class="col-10">
                                    ...
                                    <!-- end slide -->
                                    <div class="swiper-slide swiper-slide-active" style="width: 926px;" role="group" aria-label="2 / 3">
                                        <div class="row justify-content-center">
                                            <div class="col-10">
                                                <div class="text-white-50">
                                    ...
                                    <!-- end slide -->
                                    <div class="swiper-slide swiper-slide-next" role="group" aria-label="3 / 3" style="width: 926px;">
                                        <div class="row justify-content-center">
                                            <div class="col-10">
                                                <div class="text-white-50">
                                ...
                                <div class="swiper-button-next bg-white rounded-circle" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-98373dbb333460de" aria-disabled="false"></div>
                                <div class="swiper-button-prev bg-white rounded-circle" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-98373dbb333460de" aria-disabled="false"></div>
                                <div class="swiper-pagination position-relative mt-2 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal"><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 1"></span><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 2" aria-current="true"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3"></span></div>
                            <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
                            <!-- end slider -->
                        </div>
                    </div>
        ...
        <!--start back-to-top-->
        <button onclick="topFunction()" class="btn btn-danger btn-icon landing-back-top" id="back-to-top" style="display: block;">
